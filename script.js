let tasks = {
  ...
  // submit event on form to create new Task
  form.addEventListener("submit", function (e) {
    ...
    newTask.innerHTML = `<div class="header"> <p>Due on ${taskDueDate}</p> <p class="priority" style="color:${applyColor(taskPriority.trim())};">
    ${taskPriority}</p></div>
     <div>
     <p>${taskName}</p>
    <div class="buttons">
    ...
    function deleteTask() {
      ...
      document.getElementById(`${currentContainerId}-count`).innerText = `${tasks[currentContainerId].length}`;
      document.getElementById(`${currentContainerId}-high`).innerText = `${countHigh(tasks[currentContainerId])} of ${tasks[currentContainerId].length
      }`;
